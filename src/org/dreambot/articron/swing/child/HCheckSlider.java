...
/**
 * Created by: Niklas Date: 20.09.2017 Alias: Dinh Time: 19:16
 */
...
public class HCheckSlider extends HPanel {
	...
	public HCheckSlider(int preferredWidth) {
		...
		buttonPanel.add(disabled = new HCheckButton(listener -> buttonHandler(enabled, disabled), 1),
				BorderLayout.WEST);
	...
	public boolean isToggledActive() {
